...
You do not need a local version, we can host an active session on ngrok or you can use the app that we deployed through Google Cloud Run here: https://style-transfer-kxvovuvhyq-uc.a.run.app.  <br> <br>
